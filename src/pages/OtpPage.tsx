      ...
      <div className="flex min-h-screen flex-col py-4 md:min-h-full">
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <input
              ...
              className="w-full border-b border-gray-200 bg-transparent py-3 text-2xl tracking-[0.6em] outline-none transition focus:border-[#53b175]"
              placeholder="----"
              maxLength={4}
            />
          </div>
        ...
        <div className="mt-auto flex items-center justify-between pb-4">
          ...
          <button
            ...
            className="flex h-[67px] w-[67px] items-center justify-center rounded-full bg-[#53b175] text-white shadow-md disabled:opacity-40 md:hidden"
          >
            →
          </button>
          ...
          <button
            onClick={handleSubmit}
            disabled={!isComplete || isLoading}
            className="hidden rounded-xl bg-[#53b175] px-6 py-3 text-white shadow-md disabled:opacity-40 md:block"
          >
